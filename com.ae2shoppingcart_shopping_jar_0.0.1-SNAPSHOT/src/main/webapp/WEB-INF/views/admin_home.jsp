       ...
       <link rel="apple-touch-icon-precomposed" sizes="144x144" href="#">
        ...
        <title>JSP Page</title>
                      ...
                      function fetch_orders()
                     {
                         ...
                         xmlhttp.onreadystatechange = function ()
                         {
                             ...
                             } else
                             {
                                 ...
                                 tab += "<thead><tr><td>Bill id</td><td>Actual amount</td><td>Paid amount</td><td>Date time</td><td>Address</td><td>Email</td><td>Payment Mode</td><td>Phone no</td><td>Status</td><td>Status</td></tr></thead>";
                                 tab += "<tbody>";
         ...
         //                            tab+="<td><img src='" +obj.category_photo+ "'  style='width: 150px; height: 150px '/></td>";
                               // tab +="<td><input type='button' id='confirm' value='View Details' class='btn-success' onclick='vieworders("+obj.billid+")'/></td>";
                                tab +="<td><input type='button' id='confirm' value='Delivered' class='btn-success' onclick='manageorders("+obj.billid+")'/></td>";
                         ...
                         xmlhttp.open("GET", "./fetch_pending_orders", true);
                         xmlhttp.send();
                     }
         ...
         //                alert(billid);
                         ...
                         xmlhttp.onreadystatechange = function ()
                         {
                             ...
                             {
                                 var tab = "<table border=1 class='table table-bordered'>";
                                 tab += "<thead><tr><td>Bill id</td><td>Actual amount</td><td>Paid amount</td><td>QTY</td></tr></thead>";
                                 tab += "<tbody>";
                                 for (var i = 0; i < jsonar.length; i++)
                                 {
                                     var obj = jsonar[i];
         ...
         fetch_orders();
                             ...
                             // Step 2
                             xhttp.open("GET", "./manage_orders?billid="+billid, true);    // true --> async request
