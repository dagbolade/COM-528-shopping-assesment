...
@RestController
@RequestMapping("/fetch_pending_orders")
public class fetch_pending_orders
{
    ...
    public String some()
    {
        ...
        String ans = new RDBMS_TO_JSON().generateJSON("select * from billtable where status='pending'");
