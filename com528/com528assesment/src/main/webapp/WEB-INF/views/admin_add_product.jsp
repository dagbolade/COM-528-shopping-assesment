...
<!--        <h1 class="jumbotron" style="text-align: center">Category</h1>-->
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="section-2 user-page main-padding"  style="height: 150vh !important">
                            <div class="login-sec">
                                <div class="login-box">
                                    <form id="form1">
                                        <h4 class="text-light-black fw-600">Add Product</h4>
                                        <div class="row">
                                            
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="text-light-white fs-14">Product Name</label>
                                                    <input type="text" name="productname" id="productname" class="form-control form-control-submit" placeholder="Product Name" required>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="text-light-white fs-14">Max Price</label>
                                                    <input type="number" name="maxprice" id="maxprice" class="form-control form-control-submit" placeholder="maxprice" required>
                                                </div>
                                                 <div class="form-group">
                                                    <label class="text-light-white fs-14">Offer Price</label>
                                                    <input type="number" name="offerprice" id="offerprice" class="form-control form-control-submit" placeholder="Offer price" required>
                                                </div>
...
<option><%=rs.getString("category_name")%></option>
  <%  
                                     ...
                                     <div class="form-group">
                                         <button type="submit" class="btn-second-2 btn-submit full-width" onclick="add_product()">Submit</button>
                                                </div>
